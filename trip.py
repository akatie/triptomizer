...
import string #helper for string parsing
##########################################################################
    ...
    while hour < 24:
        ...
        while minute < 60:
            ...
            for airport in AirportLoc:
                ...
                rootname = unicode(isoLocal, 'utf-8') + unicode(a, 'utf-8')
                filename = "".join(rootname.split(":")) + ".json" # this removes the colon, which our PCs don't like in the filepath
